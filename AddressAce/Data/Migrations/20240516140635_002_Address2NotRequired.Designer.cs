...
namespace AddressAce.Data.Migrations
{
    ...
    [Migration("20240516140635_002_Address2NotRequired")]
    partial class _002_Address2NotRequired
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AddressAce.Models.ImageUpload", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("AddressAce.Data.ApplicationUser", b =>
                {
                    b.HasOne("AddressAce.Models.ImageUpload", "Image")
                        .WithMany()
            ...
            modelBuilder.Entity("CategoryContact", b =>
                {
                    b.HasOne("AddressAce.Models.Category", null)
                        .WithMany()
                        .HasForeignKey("CategoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AddressAce.Models.Contact", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("AddressAce.Data.ApplicationUser", null)
                        .WithMany()
